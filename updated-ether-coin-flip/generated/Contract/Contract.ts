...
export class Contract extends ethereum.SmartContract {
  ...
  activeCoinFlips(param0: BigInt): Contract__activeCoinFlipsResult {
    let result = super.call(
      "activeCoinFlips",
      "activeCoinFlips(uint256):(uint256,address,uint256,address,uint256,uint256,address,address)",
  ...
  finishedCoinFlips(param0: BigInt): Contract__finishedCoinFlipsResult {
    let result = super.call(
      "finishedCoinFlips",
      "finishedCoinFlips(uint256):(uint256,address,uint256,address,uint256,uint256,address,address)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    );
